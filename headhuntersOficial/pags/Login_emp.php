                            ...
                            <div class="hs-text">
                                <center>
                                    ...
                                    <div class="text-left" style="width: 26rem; ">
                                        <h3 class="text-center card-header border-black" style="color: #fff;">Entrar como empresa</h3>   

                                        <div class="card-body text-align-center">

                                            <form action="../php/validarLoginEmpresa.php" method="post" name="Cadastro" >

                                                <div class=" col col-sm-12 col-md-12 text-white">
                                                    <label>E-mail</label>
                                                    <input  class="form-control"  placeholder="Email" name="usuario_emp" type="text"  maxlength="45"  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required>
                                                ...
                                                <div class=" col col-sm-12 col-md-12 text-white">
                                                    <label>Senha</label>
                                                    <input class="form-control"  placeholder="Senha" name="senha_emp" type="password" maxlength="45" required>
                                                ...
                                                <center>
                                                    <div class="text-center">
                                                        <h6 style="color: #fff;">Não possui uma conta? <a href="Cadastro_emp.php"  style="color: ">Cadastre-se!</a></h6>
                                                    </div>
                                                    &ensp;
