            ...
            <section class="row">
                <div class="container">        
                    <form action="Insert.php" method="post" name="Contato" enctype="multipart/form-data">
                        ...
                        <label>Nome</label>
                        <input class="form-control" name="nome" type="text" size="100" maxlength="30" />
                        <p>&nbsp;</p>
                        <label>Email</label>
                        <input class="form-control" name="email" type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"  maxlength="45" size="100"/>
                        <p>&nbsp;</p>
                        <label>Senha</label>
                        <input class="form-control" name="senha" type="password" size="100" maxlength="45"/>
                        <p>&nbsp;</p>
                        <label>CPF</label>
                        <input class="form-control" placeholder="000.000.000-00" id="cpf" name="cpf" type="text" maxlength="14"  pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" size="100" />
                        <p>&nbsp;</p>
                        <label>Data de Nascimento</label>
                        <input class="form-control" name="data" type="date" size="100" maxlength="30" />
                        <p>&nbsp;</p>
                        <label>Celular</label>
                        <input class="form-control" placeholder="(00)00000-0000" id="celular" name="celular" type="text" size="100" maxlength="30" />
                        <p>&nbsp;</p>
                        <label>Estado</label>
