...
--
-- Host: 127.0.0.1
-- Generation Time: 25-Jun-2019 às 21:10
...
INSERT INTO `admin` (`adm_id`, `adm_nome`, `adm_login`, `adm_senha`) VALUES
(7, 'Marcel', 'marcel', '123');
...
INSERT INTO `cidade` (`cid_id`, `cid_nome`, `cid_est_id`) VALUES
(3, 'Brasiléia', 1),
(4, 'Bujari', 1),
(5, 'Capixaba', 1),
(6, 'Cruzeiro do Sul', 1),
...
CREATE TABLE `cliente` (
  ...
  `cli_email` varchar(255) CHARACTER SET armscii8 NOT NULL,
  `cli_senha` varchar(255) NOT NULL,
  `cli_cpf` char(15) NOT NULL,
  `cli_data_nasc` date NOT NULL,
  `cli_celular` char(14) NOT NULL,
  `cli_id_estado` varchar(255) CHARACTER SET latin1 COLLATE latin1_bin NOT NULL,
  `cli_id_cidade` varchar(255) NOT NULL,
  `cli_id_genero` varchar(45) NOT NULL,
  `cli_img` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `cliente` (`cli_id`, `cli_nome`, `cli_email`, `cli_senha`, `cli_cpf`, `cli_data_nasc`, `cli_celular`, `cli_id_estado`, `cli_id_cidade`, `cli_id_genero`, `cli_img`) VALUES
(17, 'Usuario 1', 'usu1@usu1.com', '123', '59925966078', '2000-03-21', '14998741252', '18', '5404', '1', '031dad3f186d328567b4cbaf2389912c.png'),
(18, 'Usuario 2', 'usu2@usu2.com', '123', '83912846030', '1998-09-12', '12987734521', '14', '4302', '2', '0f9e80f334f620cd687491b510e6e19e.png'),
(19, 'Usuario 3', 'usu3@usu3.com', '123', '19035442032', '1987-07-04', '34981184124', '19', '6420', '3', '32eaf29276891c9753a6809a28827d93.png'),
(20, 'Usuario 4', 'usu4@usu4.com', '123', '86976653023', '1991-11-30', '86976653023', '13', '4056', '1', '7a975ac36c237d134d23503109ed5c54.png'),
(21, 'Usuario 5 ', 'usu5@usu5.com', '123', '62938978030', '1999-08-09', '62938978030', '4', '317', '2', 'cef0f3ce4bcf9030d7c969f12895f8dd.png');
...
CREATE TABLE `contato` (
  ...
  `con_assunto` varchar(255) NOT NULL,
  `con_mensagem` longtext NOT NULL,
  `con_datadeenvio` date NOT NULL,
  `con_email` varchar(255) NOT NULL,
  `con_tipousuario` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `contato` (`con_id`, `con_assunto`, `con_mensagem`, `con_datadeenvio`, `con_email`, `con_tipousuario`) VALUES
(31, 'Design do site', 'O design do site ficou show!', '2019-06-22', 'teste1@gmail.com', 'Cliente'),
(32, 'Telas de vídeo', 'As telas de vídeo ficaram bem elegantes ', '2019-06-22', 'teste2@gmail.com', 'Empresa');
...
CREATE TABLE `empresa` (
  ...
  `emp_representante` varchar(255) NOT NULL,
  `emp_razao` varchar(45) NOT NULL,
  `emp_email` varchar(45) NOT NULL,
  `emp_senha` varchar(45) NOT NULL,
  `emp_estado` int(11) NOT NULL,
  `emp_cidade` int(11) NOT NULL,
  `emp_imagem` longtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `empresa` (`emp_id`, `emp_cnpj`, `emp_representante`, `emp_razao`, `emp_email`, `emp_senha`, `emp_estado`, `emp_cidade`, `emp_imagem`) VALUES
(12, '75785071000146', 'Empresa 1', 'Razao 1 ', 'emp1@emp1.com', '123', 20, 6705, 'fcb9985be993d7a8acddec5c20f9f9e1.png'),
(13, '72834642000105', 'Empresa 2', 'Razao 2', 'emp2@emp2.com', '123', 26, 8400, 'f4de5ceba3908795143219b0a22f7350.png'),
(14, '92892611000100', 'Empresa 3', 'Razao 3', 'emp3@emp3.com', '123', 8, 1708, '4f63d63ca279a9f44739bd8856b9c964.png'),
(15, '29261462000144', 'Empresa 4', 'Razao 4', 'emp4@emp4.com', '123', 5, 511, '51021ad5786dc4d7546ae29ed6aa691f.png'),
(16, '64401744000109', 'Empresa 5', 'Razao 5', 'emp5@emp5.com', '123', 14, 4327, '9d1e9efb6f13b58a7f3ed092dd7bf00b.png');
...
INSERT INTO `estado` (`est_id`, `est_uf`, `est_sigla`) VALUES
(1, 'Acre', 'AC'),
(2, 'Alagoas', 'AL'),
(3, 'Amazonas', 'AM'),
(4, 'Amapá', 'AP'),
...
CREATE TABLE `genero` (
  ...
  `sexo_opcao` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `genero` (`sexo_id`, `sexo_opcao`) VALUES
(1, 'Masculino'),
(2, 'Feminino'),
(3, 'Outros');
...
CREATE TABLE `video` (
  ...
  `vid_subtit` varchar(45) NOT NULL,
  `vid_escola` varchar(255) NOT NULL,
  `vid_orientador` varchar(255) NOT NULL,
  `vid_cat_id` int(11) NOT NULL,
  `vid_equipe` longtext NOT NULL,
  `vid_descricao` longtext NOT NULL,
  `vid_cli_id` int(11) NOT NULL,
  `vid_dataenvio` date NOT NULL,
  `vid_linkyt` varchar(255) NOT NULL,
  `vid_imagem` longtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `video` (`vid_id`, `vid_titulo`, `vid_subtit`, `vid_escola`, `vid_orientador`, `vid_cat_id`, `vid_equipe`, `vid_descricao`, `vid_cli_id`, `vid_dataenvio`, `vid_linkyt`, `vid_imagem`) VALUES
(81, 'GoShop', 'Uma maneira fácil de comprar', 'Escola teste', 'Orientador teste', 1, 'A nossa equipe é formada por mim e mais 3 colegas. Ao longo do desenvolvimento do nosso sistema web, fomos dividindo as funções para as áreas que mais eram adequadas para cada membro.', 'GoShop, um administrador de vendas com suporte a banco de dados SQL, onde o administrador poderá moldar para conseguir atender os interesses dele e de seus clientes. O GoShop permite mudar nome de produtos, organizar por categoria, além de fazer o mesmo com as categorias registradas.', 17, '2019-06-25', '4DAbnHv6VHs', 'b3899eec03e6935160da2dbc8d298d7e.png'),
(82, 'Vamos Aprender!', 'Um jeito diferente de se aprender', 'Escola teste', 'Orientador teste', 4, 'O projeto \"Vamos Aprender\" foi desenvolvido somente por mim e foi uma ótima experiência para que eu adquirisse mais conhecimento na área da linguagem Java. Ao longo do desenvolvimento do projeto, me senti cada vez mais na necessidade de procurar mais conhecimento sobre a linguagem, uma vez que eu tinha um cronograma de trabalho no meu TCC de aproximadamente 3 horas por dia.', 'O projeto \"Vamos Aprender\", é um sistema web onde o usuário poderá encontrar os mais variados tipos de apostila referentes ao conteúdos aplicados do ensino médio. Além disso poderá compartilhar informações com outros alunos e interagir com eles em um chat.\r\n', 17, '2019-06-25', '4DAbnHv6VHs', '150c8dbabb16418d018e8472bfe56d01.png'),
(83, 'CleanFast', 'Otimizador ideal para o seu computador', 'Escola teste', 'Orientador Teste', 4, 'A equipe de desenvolvimento é formada por 3 alunos\r\n\r\nAluno1(códigos)\r\nAluno2(documentação)\r\nAluno3(design)', 'Clean fast serve para limpar arquivos desnecessários de seu computador, fazendo com que o mesmo ganhe velocidade e consiga ter um arranque mais rápido\r\n\r\nFoi desenvolvido na linguagem Java, devido a facilidade de utilizar em todas as versões do Windows.', 20, '2019-06-18', '4DAbnHv6VHs', '150c8dbabb16418d018e8472bfe56d02.png\r\n'),
(84, 'Learn SQL', 'Aprenda SQL de uma maneira fácil', 'Escola teste', 'Orientador teste', 6, 'O jogo em C# \"Learn SQL\" é um projeto feito por um grupo de 3 pessoas. Durante o desenvolvimento do nosso jogo, foi ficando cada vez mais necessário usarmos de base alguns projetos em C# que eram do gênero Quiz.', 'O projeto \"Learn SQL\" é um Quiz feito na linguagem de programação C# e visa auxiliar os estudantes na área de SQL. Com vários níveis de dificuldade em várias áreas da linguagem SQL, o jogo funciona de uma forma intuitiva e que equilibra bem os níveis de dificuldade conforme o jogador avança nas perguntas. ', 19, '2019-06-24', '4DAbnHv6VHs', '150c8dbabb16418d018e8472bfe56d03.png'),
(85, 'Car Selling System', 'Uma solução prática para a venda de automóvei', 'Escola teste', 'Orientador teste', 4, 'O projeto \"Car Selling System\" é um projeto feito por um grupo de 5 pessoas, onde cada integrante ficou com uma parte em específica do projeto. 3 integrantes ficaram com a parte do relatório e eu e mais um ficou na parte da programação em Java.', 'O projeto \"Car Selling System\" é um sistema que gerencia automóveis em uma concessionária de qualquer marca. Com uma interface bem intuitiva, o sistema tem como objetivo efetuar vendas de carros usados ou 0Km. O sistema também  gera relatórios das vendas a partir dos dados das vendas mais recentes ou por outra filtragem que o usuário desejar.', 18, '2019-06-25', '4DAbnHv6VHs', '150c8dbabb16418d018e8472bfe56d04.png');
...
ALTER TABLE `cidade`
  ...
  ADD KEY `fk_cid_estados` (`cid_est_id`);
...
--
ALTER TABLE `video`
  MODIFY `vid_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;
...
--
ALTER TABLE `cidade`
  ADD CONSTRAINT `fk_cid_estados` FOREIGN KEY (`cid_est_id`) REFERENCES `estado` (`est_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
